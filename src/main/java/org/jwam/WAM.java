        ...
        extends Symbol
{
    ...
    public void putVariable(String v, String a)
            throws Exception
    {
        switch (v.charAt(0)) {
            case 'Y':
    ...
    public void putVariableHeap(String Xn, String Ai)
            throws Exception
    {
    ...
    public void putVariableStack(String Yn, String Ai)
            throws Exception
    {
    ...
    public void putValue(String Vn, String Ai)
            throws Exception
    {
    ...
    public void putUnsafeValue(String Yn, String Ai)
            throws Exception
    {
        int E = registers.getE(),
                H = registers.getH(),
                n = Util.getRegisterIndex(Yn) + 1;
    ...
    public void putStructure(String f, String Ai)
            throws Exception
    {
        int H = registers.getH();
    ...
    public void putConstant(String c, String Ai)
            throws Exception
    {
    ...
    public void getVariable(String Vn, String Ai)
            throws Exception
    {
    ...
    public void getValue(String Vn, String Ai)
            throws Exception
    {
        if (!unify(registers.getRegister(Vn).getValue(),
                registers.getRegister(Ai).getValue())) {
            registers.setP(code.getAddrNextInstruction());
        }
        else {
            backtrack();
    ...
    public void getStructure(String f, String Ai)
            throws Exception
    {
        boolean fail = false;
        int H = registers.getH();
    ...
    public void getConstant(String c, String Ai)
            throws Exception
    {
    ...
    public void setVariable(String Vn)
            throws Exception
    {
        int H = registers.getH();
        heap.setAddress(H, H);
    ...
    public void setValue(String Vn)
            throws Exception
    {
        int H = registers.getH();
    ...
    public void setLocalValue(String Vn)
            throws Exception
    {
        int H = registers.getH();
    ...
    public void unifyValue(String Vn)
            throws Exception
    {
        boolean fail = false;
    ...
    public void unifyLocalValue(String Vn)
            throws Exception
    {
        boolean fail = false;
        int S = registers.getS();
    ...
    public void unifyConstant(String c)
            throws Exception
    {
        int H = registers.getH();
        boolean fail = false;
    ...
    public void unifyVoid(String v)
            throws Exception
    {
        int n = Util.arity(v),
                S = registers.getS(),
    ...
    public void tryMeElse(String v)
            throws Exception
    {
        //int L = Util.arity(v),
        int E = registers.getE(),
        ...
        if (E > B) {
            n = Util.arity(
                    code.getAddress(stack.getValue(E + 1) - 1).getStringValue());
    ...
    public void retryMeElse(String v)
            throws Exception
    {
        //int L = Util.arity(v),
        int B = registers.getB(),
                n = stack.getAddress(B).getValue(),
                TR = registers.getTR();
            ...
            throws Exception
    {
        ...
        if (E > B) {
            n = Util.arity(
                    code.getAddress(
                            stack.getAddress(E + 1).getValue() - 1).getStringValue());
    ...
    public void bind(int a1, int a2)
            throws Exception
    {
    ...
    public boolean unify(int a1, int a2)
            throws Exception
    {
        pdl.push(a1);
        pdl.push(a2);
            ...
            if (d1 != d2) {
                ...
                if (c1.equals(REF)) {
                    ...
                    switch (c2.getTag()) {
                        ...
                        case CON:
                            fail = ((!c1.equals(CON)) ||
                                    (!c1.getStringValue().equals(c2.getStringValue())));
                            break;
                        case LIS: {
                            if (!c1.equals(LIS)) {
                                fail = true;
            ...
            extends Memory
    {
        ...
        public String getLabelsList()
        {
            ...
            String s = "";
            for (int i = 0; i < lastInstruction; i++) {
                if (!memory[i].compareToLabel(" ") &&
                        !memory[i].compareToLabel("query$") &&
                        !labels.contains(memory[i].label())) {
            ...
            return (s.equals("")) ? "Any label found" :
                    "Avaliable Labels:\n" + s;
        }
        ...
        public int instructionSize(int address)
                throws InvalidInstruction
        {
            if (memory[address] == null) {
                throw new InvalidInstruction(
                        "There is no instruction at memory address 0x" + address);
            }

            else if (!memory[address].equals(CON)) {
                throw new InvalidInstruction(
                        "Invalid instruction at memory address 0x" + address +
                                " " + memory[address].toString());
            }

            else if (Symbol.keys.containsKey(memory[address].getStringValue())) {
                return Symbol.INSTRUCTIONS_SIZE[Symbol.keys.get(
                        memory[address].getStringValue())];
            }

            else {
                throw new InvalidInstruction("Unknown instruction <" +
                        memory[address].getStringValue() + ">");
            }
        }
         ...
         */
        public int getAddrNextInstruction()
                throws InvalidInstruction
        {
            int P = registers.getP();
            ...
            for (int i = 0; i < lastInstruction; ) {
                ...
                for (int n = 0; n < j; n++) {
                    if (memory[i + n] == null || !memory[i + n].equals(CON)) {
                        throw new InvalidInstruction(
                                "Malformed instruction starting at memory address " + i);
                    }
                }
                i += j;
                p++;
                ...
                throws InvalidInstruction
        {
            ...
            s += Util.createSpaces(12) + "[" + number +
                    (lastInstruction + 1) + "] - [" +
                    number2 + eofCodeArea + "]\tEmpty Code Space\n";
            ...
            extends Memory
    {
        ...
        {
            int t = Util.nrDigits(memory.length),
                    heapPointer = registers.getH(), S = registers.getS(),
                    HB = registers.getHB();
            ...
            for (int i = heapBottomLimit; i <= heapUpperLimit; ) {
                ...
                int j = 0;
                while (heapPointer != i + j && S != i + j && HB != i + j &&
                        i + j <= heapUpperLimit && memory[i + j] == null) {
                    j++;
                }
                ...
                if (j != 0 || (i + j <= heapUpperLimit && memory[i + j] == null)) {
                    ...
                    if (tag == REF || tag == STR || tag == LIS || tag == CON || tag == FUN) {
                        ...
                        throw new HeapException(
                                "Malformed heap content at memory address " + i);
                    }
                }
                i += (j != 0) ? j : 1;
                s += "\n";
            ...
            extends Memory
    {
        ...
        {
            int t = Util.nrDigits(memory.length),
                    E = registers.getE(), B = registers.getB(),
                    cutPointer = registers.getB0(), CE = registers.getCE();
            ...
            for (int i = stackBottomLimit; i <= stackUpperLimit; ) {
                ...
                int j = 0;
                while (E != i + j && B != i + j && cutPointer != i + j &&
                        i + j <= stackUpperLimit && memory[i + j] == null) {
                    j++;
                }
                ...
                if (j != 0 || (i + j <= stackUpperLimit && memory[i + j] == null)) {
                    ...
                    if (tag == REF || tag == STR || tag == LIS || tag == CON || tag == FUN) {
                        ...
                        throw new StackException(
                                "Malformed stack content at memory address 0x" + i);
                    }
                }
                ...
                throws Exception
        {
            ...
            for (int i = trailBottomLimit; i <= registers.getTR(); ) {//trailUpperLimit;){
                ...
                if (j != 0) {
                    ...
                    throw new Exception(
                            "Malformed trail content at memory address 0x" + i);
                }
            ...
            extends Memory
    {
        ...
        public boolean empty() { return pdlBottomLimit == pdlUpperLimit; }
                ...
                throws Exception
        {
            ...
            for (int i = registers.getTR() + 1; i <= pdlUpperLimit; ) {
                ...
                if (memory[i] == null && i == pdlBottomLimit) {
                    ...
                    throw new Exception(
                            "Malformed PDL content at memory address 0x" + i);
                }
            ...
            extends Memory
    {
        ...
        public void setRegister(String key, DataCell a)
                throws Exception
        {
        ...
        public DataCell getRegister(String key)
                throws Exception
        {
            ...
            extends Memory
    {
        ...
        public void setS(int n) { S = n; }

        public void setHB(int n) {HB = n; }

        public void setH(int n) { H = n; }

        public void setB0(int n) { B0 = n; }

        public void setB(int n) { B = n; }

        public void setE(int n) { E = n; }

        public void setTR(int n) { TR = n; }

        public void setP(int n) { P = n; }

        public void setCP(int n) { CP = n; }

        public void setCE(int n) { CE = n; }

        public DataCell getRegister(Vector<DataCell> reg, int i)
        {
            int length = reg.size();
            while (length++ < i + 1) {
                reg.addElement(new DataCell(Symbol.CON, "null", length));
            }
        ...
        public void setRegister(Vector<DataCell> reg, int i, DataCell d)
        {
            ...
            reg.set(i, new DataCell(Symbol.CON, d.getStringValue(), d.getValue()));
        ...
        public DataCell getRegister(String register)
        {
            ...
            switch (register.charAt(0)) {
                ...
                default:
                    return new DataCell(Symbol.CON, "null", 0);
            }
        }
        ...
        public String printRA()
        {
            ...
            for (int i = 0; i < RA.size(); i++) {
                ...
                if (dc.equals(Symbol.CON) && (r == null || r.equals("null") || r.trim().equals(""))) {
                    r = "0x" + dc.getValue();
                }

                s += "\nA" + i + ": " +
                        ((r == null || r.equals("null") || r.trim().equals("")) ? " " : r + " ");
            }
            return s;
        }
    ...
    public void writeLn(String s) { System.out.println(s); }
